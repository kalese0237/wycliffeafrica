...
function buttonClassName({
  ...
  return cn(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md border font-ui font-semibold shadow-sm transition-[background-color,border-color,box-shadow] duration-130 ease-[cubic-bezier(0.4,0,0.2,1)] active:shadow-inset focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--color-focus-ring)",
