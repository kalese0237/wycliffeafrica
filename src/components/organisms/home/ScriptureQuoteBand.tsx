  ...
  return (
    <section className="relative overflow-hidden bg-terra-900">
      ...
      <div className="relative mx-auto flex max-w-(--container-max) flex-col items-center gap-6 px-5 py-24 text-center sm:px-12">
        <div className="font-ui text-xs font-bold uppercase tracking-[0.2em] text-green-400">
          Matthew 28:19-20
        </div>
        <blockquote className="max-w-[42ch] font-display text-2xl italic leading-[1.4] text-white sm:text-3xl lg:text-4xl">
