...
const SLIDES: Slide[] = [
  {
    ...
    body: "Millions across Africa are still waiting to hear God speak their language. We raise, train and send African missionaries until every people group holds the Word in the tongue of their heart.",
  ...
  },
  {
    ...
    body: "From literacy teachers to linguists, we train and send African missionaries equipped to serve translation projects across the continent — for a season, or for a lifetime.",
  ...
  },
  {
    ...
    body: "We walk alongside congregations to pray, give, and send — until every language community holds Scripture in the tongue of their heart.",
